...
export async function GET(req: NextRequest) {
  try {
    ...
    // Auto-seed initial active published flight schedules if none exist in the database
    if (flights.length === 0) {
      const now = new Date();
      const defaultFlights = [
        {
          ...
          arrivalTime: new Date(now.getTime() + (2 * 24 + 5) * 60 * 60 * 1000),
          duration: 300,
          totalSeats: 200,
          availableSeats: 198,
          pricePerSeat: 115000,
          ...
          baggage: '20+7 KG',
          meal: true,
          category: 'Umrah Group',
          status: 'active',
          fareTiers: JSON.stringify([
            { upToSeat: 50, price: 115000 },
            { upToSeat: 100, price: 125000 },
            { upToSeat: 200, price: 135000 },
          ]),
        },
        {
          flightNumber: 'PK-739',
          ...
          arrivalTime: new Date(now.getTime() + (3 * 24 + 5) * 60 * 60 * 1000),
          duration: 300,
          totalSeats: 180,
          availableSeats: 180,
          pricePerSeat: 112000,
          ...
          status: 'active',
          fareTiers: JSON.stringify([
            { upToSeat: 50, price: 112000 },
            { upToSeat: 180, price: 120000 },
          ]),
        },
        {
          flightNumber: 'PA-210',
          ...
          departureCity: 'ISB',
          arrivalCity: 'DXB',
          departureTime: new Date(now.getTime() + 1 * 24 * 60 * 60 * 1000),
          arrivalTime: new Date(now.getTime() + (1 * 24 + 3.5) * 60 * 60 * 1000),
          duration: 210,
          totalSeats: 150,
          availableSeats: 150,
          pricePerSeat: 85000,
          ...
          status: 'active',
          fareTiers: JSON.stringify([
            { upToSeat: 50, price: 85000 },
            { upToSeat: 150, price: 95000 },
          ]),
        },
        {
          flightNumber: 'ER-502',
          ...
          departureCity: 'KHI',
          arrivalCity: 'ISB',
          departureTime: new Date(now.getTime() + 4 * 24 * 60 * 60 * 1000),
          arrivalTime: new Date(now.getTime() + (4 * 24 + 2) * 60 * 60 * 1000),
          duration: 120,
          totalSeats: 120,
          availableSeats: 120,
          pricePerSeat: 38000,
          ...
          status: 'active',
          fareTiers: JSON.stringify([
            { upToSeat: 40, price: 38000 },
            { upToSeat: 120, price: 45000 },
          ]),
        },
        {
          flightNumber: 'EK-623',
          ...
          arrivalTime: new Date(now.getTime() + (5 * 24 + 3.5) * 60 * 60 * 1000),
          duration: 210,
          totalSeats: 250,
          availableSeats: 250,
          pricePerSeat: 145000,
          ...
          status: 'active',
          fareTiers: JSON.stringify([
            { upToSeat: 50, price: 145000 },
            { upToSeat: 250, price: 160000 },
          ]),
        },
      ];

      await prisma.flight.createMany({ data: defaultFlights });
      flights = await prisma.flight.findMany({ orderBy: { departureTime: 'asc' } });
    }
