...
import { X, Phone, Sparkles, Clock, ShieldCheck, Tag, ArrowRight } from 'lucide-react';
          ...
          <div className="md:col-span-7 flex flex-col justify-between p-4 sm:p-5 md:p-6 bg-gradient-to-b from-slate-950 via-slate-900/80 to-slate-950 relative overflow-hidden">
            ...
            <div className="pr-8 mb-2 sm:mb-3">
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-black tracking-tight text-white leading-tight">
                14th August <span className="bg-gradient-to-r from-amber-300 via-yellow-200 to-amber-400 bg-clip-text text-transparent">Azadi Freedom Sale</span>
              </h3>
              <p className="text-xs sm:text-sm text-slate-300 font-medium mt-1">
                Get up to <strong className="text-emerald-400 font-bold">10% OFF</strong> on Domestic & International Flights.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 my-2">
              <div className="flex items-center gap-1.5 bg-emerald-950/40 border border-emerald-500/20 rounded-xl p-2">
                ...
                <span className="text-[10px] sm:text-[11px] font-bold text-emerald-200 truncate">10% Air Ticket OFF</span>
              </div>
              <div className="flex items-center gap-1.5 bg-emerald-950/40 border border-emerald-500/20 rounded-xl p-2">
                <ShieldCheck className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                <span className="text-[10px] sm:text-[11px] font-bold text-amber-200 truncate">Zero Service Fee</span>
              </div>
              <div className="flex items-center gap-1.5 bg-emerald-950/40 border border-emerald-500/20 rounded-xl p-2">
                <Sparkles className="w-3.5 h-3.5 text-yellow-300 shrink-0" />
                <span className="text-[10px] sm:text-[11px] font-bold text-yellow-200 truncate">Instant Confirmation</span>
              </div>
            </div>
