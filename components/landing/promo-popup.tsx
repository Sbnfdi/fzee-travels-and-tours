  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-5 md:p-6 overflow-hidden">
      ...
      <div className={`relative w-full max-w-[340px] sm:max-w-[400px] md:max-w-[760px] lg:max-w-[820px] my-auto transition-all duration-500 ease-out ${isAnimating ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-90 translate-y-8'}`}>
        ...
        <div className="absolute -inset-1.5 bg-gradient-to-r from-emerald-500/40 via-amber-400/30 to-emerald-500/40 rounded-3xl blur-2xl opacity-75 pointer-events-none animate-pulse" />
        ...
        <div className="relative bg-slate-950 border border-emerald-500/35 rounded-2xl sm:rounded-3xl shadow-[0_25px_100px_rgba(0,0,0,0.95),0_0_60px_rgba(16,185,129,0.25)] overflow-hidden max-h-[92vh] flex flex-col md:grid md:grid-cols-12">
          ...
          {/* Right Column: Promotional Details, Live Countdown & CTAs (Desktop: 7 cols) */}
          <div className="md:col-span-7 flex flex-col justify-between p-4 sm:p-5 md:p-6 bg-gradient-to-b from-slate-950 via-slate-900/80 to-slate-950 relative overflow-hidden">
            ...
            <div className="pr-8 mb-2 sm:mb-3">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                {timeLeft.isExpired ? (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-red-500/15 border border-red-500/40 text-[10px] sm:text-[11px] font-black uppercase tracking-widest text-red-300">
              ...
              <p className="text-xs sm:text-sm text-slate-300 font-medium mt-1">
                {timeLeft.isExpired ? (
                  ...
                  <span>
                    Get <strong className="text-emerald-400 font-bold">10% OFF</strong> on Domestic Air Tickets. Travel different, experience more!
                  </span>
                )}
              </p>
            </div>
            ...
            {timeLeft.isExpired ? (
              <div className="bg-slate-950/95 border border-red-500/30 rounded-xl sm:rounded-2xl p-3.5 sm:p-4 my-2 shadow-xl relative overflow-hidden">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[10px] font-extrabold text-red-300 bg-red-500/15 px-2 py-0.5 rounded-md border border-red-500/30">
                    Expired on 06 Sep 11:59 PM
                  </span>
                </div>
                <div className="bg-slate-900/80 border border-red-500/20 rounded-xl p-3 text-center">
                  <div className="inline-flex items-center gap-2 text-red-400 font-black text-sm sm:text-base uppercase tracking-wider mb-1">
              ...
              <div className="bg-slate-950/90 border border-emerald-500/30 rounded-xl sm:rounded-2xl p-3 sm:p-3.5 my-2 shadow-xl relative overflow-hidden">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {[
                    ...
                    <div 
                      key={idx} 
                      className="relative bg-slate-900 border border-emerald-500/30 rounded-xl p-2 text-center shadow-inner group hover:border-amber-400/50 transition-colors"
                    >
                      <span className="block font-mono text-xl sm:text-2xl md:text-3xl font-black text-amber-300 tracking-tight drop-shadow-[0_2px_10px_rgba(251,191,36,0.3)]">
                        {padZero(item.val)}
                      </span>
            ...
            <div className="grid grid-cols-3 gap-2 my-2">
              <div className="flex items-center gap-1.5 bg-emerald-950/40 border border-emerald-500/20 rounded-xl p-2">
                <Tag className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                <span className="text-[10px] sm:text-[11px] font-bold text-emerald-200 truncate">10% Domestic OFF</span>
              </div>
              <div className="flex items-center gap-1.5 bg-emerald-950/40 border border-emerald-500/20 rounded-xl p-2">
                <ShieldCheck className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                <span className="text-[10px] sm:text-[11px] font-bold text-amber-200 truncate">Limited Seats</span>
              </div>
              <div className="flex items-center gap-1.5 bg-emerald-950/40 border border-emerald-500/20 rounded-xl p-2">
                <Sparkles className="w-3.5 h-3.5 text-yellow-300 shrink-0" />
                <span className="text-[10px] sm:text-[11px] font-bold text-yellow-200 truncate">Best Fares</span>
              </div>
            </div>

            {/* Action Buttons Footer */}
            <div className="flex items-center gap-2.5 pt-3 border-t border-emerald-500/20 mt-2">
              
              {/* Direct Phone Call Button */}
              <a 
                href="tel:03304084080"
                className="flex-1 bg-slate-900 hover:bg-slate-800 border border-white/15 hover:border-emerald-400/40 rounded-xl px-3 py-2.5 transition-all duration-300 flex items-center justify-center gap-2 group shadow-md"
              >
                <Phone className="w-4 h-4 text-emerald-400 group-hover:scale-110 transition-transform" />
                <div className="text-left">
                  <span className="block text-[9px] text-slate-400 font-medium leading-none">Call Direct</span>
                  <span className="block text-xs sm:text-sm font-black text-white leading-tight">0330-4084080</span>
                </div>
              </a>
              ...
              <a 
                ...
                onClick={handleClose}
                className="flex-1 bg-gradient-to-r from-emerald-600 via-green-500 to-emerald-600 hover:from-emerald-500 hover:to-green-400 text-white rounded-xl px-3.5 py-3 font-black text-xs sm:text-sm transition-all duration-300 shadow-[0_0_25px_rgba(16,185,129,0.4)] hover:shadow-[0_0_35px_rgba(16,185,129,0.7)] flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 border border-emerald-300/30 uppercase tracking-wider group"
              >
