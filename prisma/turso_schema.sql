...
CREATE TABLE "Booking" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Booking_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    ...
    CONSTRAINT "Booking_visaId_fkey" FOREIGN KEY ("visaId") REFERENCES "VisaService" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
